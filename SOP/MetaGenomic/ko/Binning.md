...
[MetaBAT2](https://bitbucket.org/berkeleylab/metabat/src/master/)외에도 광범위하게 쓰이는 다른 binning 프로그램으로는 [MaxBin 2.0](https://sourceforge.net/projects/maxbin/), [CONCOCT](https://github.com/BinPro/CONCOCT)가 있다.  
...
MetaBAT2를 이용하여 binning이 완료된 후 형성된 bin들의 quality control을 [CheckM](https://github.com/Ecogenomics/CheckM)을 사용하여 시행한다.
